...
mod tests {
    ...
    fn inheritance_uses_child_scalars_parent_first_arguments_and_replaced_libraries() {
        ...
        let version =
            crate::tasks::block_on(service.resolved_version("child")).expect("child resolves");
    ...
    fn cyclic_or_excessive_parent_chains_return_the_stable_metadata_error() {
        ...
        let cyclic_error =
            crate::tasks::block_on(cyclic.resolved_version("one")).expect_err("cycle is rejected");
        ...
        let deep_error = crate::tasks::block_on(deep.resolved_version("v0"))
    ...
    fn etag_and_verified_last_known_good_control_cache_fallback() {
        ...
        let first = crate::tasks::block_on(service.stable_releases()).expect("network manifest");
        let second = crate::tasks::block_on(service.stable_releases()).expect("304 cache manifest");
        ...
        assert!(!crate::tasks::block_on(offline.stable_releases())
        ...
        let error = crate::tasks::block_on(rejected.stable_releases())
        ...
        let error = crate::tasks::block_on(corrupt_service.stable_releases())
    ...
    fn version_json_hash_mismatch_is_rejected_before_caching() {
        ...
        let error = crate::tasks::block_on(service.resolved_version("one"))
